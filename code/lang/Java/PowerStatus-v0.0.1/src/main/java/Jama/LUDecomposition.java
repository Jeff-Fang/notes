 ...
 * ------------------------ */
   ...
   */
   ...
   /** Determinant
   @return     det(A)
   @exception  IllegalArgumentException  JamaMatrix must be square
   */
   ...
   @exception  RuntimeException  JamaMatrix is singular.
   */

   public JamaMatrix solve (JamaMatrix B) {
      if (B.getRowDimension() != m) {
         throw new IllegalArgumentException("JamaMatrix row dimensions must agree.");
      }
      if (!this.isNonsingular()) {
         throw new RuntimeException("JamaMatrix is singular.");
      }
