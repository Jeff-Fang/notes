...
public class MatrixUtilV1 {
     ...
     * @return
     */
    public static boolean matrixEquals(JamaMatrix a, JamaMatrix b) {
     ...
     * @return
     */
    public static boolean checkMatrixDimensions(JamaMatrix a, JamaMatrix b) {
     ...
     */
    public static void setMatrixValue(JamaMatrix matrix, int value, int... indexes) {
