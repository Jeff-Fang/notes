...
def boot():
    ...
    robot.subscribe(topic='/mir_log', callback=callback_mirlog_data)
    robot.subscribe(topic='/f_scan', callback=callback_fscan_data)
    return robot
...
def callback_mirlog_data(msg):
    data['mirlog'] = msg

def callback_fscan_data(msg):
    data['fscan'] = msg
