 ...
 * ------------------------ *\
   ...
   *\
   ...
   public CholeskyDecomposition (JamaMatrix Arg, int rightflag) {
      // Initialize.
      double[][] A = Arg.getArray();
 ...
 * ------------------------ */
   ...
   */
   ...
   public JamaMatrix solve (JamaMatrix B) {
      ...
      if (!isspd) {
         throw new RuntimeException("JamaMatrix is not symmetric positive definite.");
      }
